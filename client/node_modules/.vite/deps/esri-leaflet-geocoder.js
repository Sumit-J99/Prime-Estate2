...
var TiledMapLayer = import_leaflet9.TileLayer.extend({
  ...
  createTile: function(coords, done) {
    ...
    tile.alt = "";
    if (!this._lodMap || this._lodMap && this._lodMap[this._getZoomForUrl()] !== void 0) {
  ...
  _redraw: function(id) {
    ...
    if (layer && layer.setStyle && this.options.pointToLayer) {
      var getStyle = this.options.pointToLayer(
        geojson,
        (0, import_leaflet15.latLng)(geojson.geometry.coordinates[1], geojson.geometry.coordinates[0])
      );
...
var ArcgisOnlineProvider = GeocodeService.extend({
  ...
  suggestions: function(text, bounds2, callback) {
    ...
    if (this.options.nearby) {
      request2.nearby(this.options.nearby);
    }
